...
Source0  : https://sourceforge.net/projects/hamlib/files/hamlib/4.5.4/hamlib-4.5.4.tar.gz
Source1  : https://sourceforge.net/projects/hamlib/files/hamlib/4.5.4/hamlib-4.5.4.tar.gz.asc
...
%prep
%setup -q -n hamlib-4.5.4
cd %{_builddir}/hamlib-4.5.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673367556
