...
Version  : 4.6
Release  : 73
URL      : https://sourceforge.net/projects/hamlib/files/hamlib/4.6/hamlib-4.6.tar.gz
Source0  : https://sourceforge.net/projects/hamlib/files/hamlib/4.6/hamlib-4.6.tar.gz
Source1  : https://sourceforge.net/projects/hamlib/files/hamlib/4.6/hamlib-4.6.tar.gz.asc
...
%setup -q -n hamlib-4.6
cd %{_builddir}/hamlib-4.6
%patch -P 1 -p1
pushd ..
cp -a hamlib-4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735071054
