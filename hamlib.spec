...
Version  : 4.6.3
Release  : 79
URL      : https://sourceforge.net/projects/hamlib/files/hamlib/4.6.3/hamlib-4.6.3.tar.gz
Source0  : https://sourceforge.net/projects/hamlib/files/hamlib/4.6.3/hamlib-4.6.3.tar.gz
Source1  : https://sourceforge.net/projects/hamlib/files/hamlib/4.6.3/hamlib-4.6.3.tar.gz.asc
...
%setup -q -n hamlib-4.6.3
cd %{_builddir}/hamlib-4.6.3
%patch -P 1 -p1
pushd ..
cp -a hamlib-4.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749566728
